...
from ..renderers import OctreeRenderer, MeshRenderer,GaussianRenderer
...
def render_multiview(sample, resolution=512, nviews=30,**kwargs):
    ...
    extrinsics, intrinsics = yaw_pitch_r_fov_to_extrinsics_intrinsics(yaws, pitchs, r, fov) #计算相机内外参
    res = render_frames(sample, extrinsics, intrinsics, {'resolution': resolution, 'bg_color': bg_color}, **kwargs)
